...
public enum SoundEventEnum implements EnumKeyInterface<Integer> {
	...
	GATE_MILKYWAY_OPEN(12, "gate_milkyway_open", 1.5f, true),
	GATE_MILKYWAY_CLOSE(13, "gate_milkyway_close", 1.5f, true),
	GATE_MILKYWAY_DIAL_FAILED(14, "gate_milkyway_dial_fail", 1.5f, true),
	GATE_MILKYWAY_DIAL_FAILED_COMPUTER(15, "gate_milkyway_dial_fail_computer", 1.5f, true),
	GATE_MILKYWAY_INCOMING(16, "gate_milkyway_incoming", 1.5f, true),
	
	GATE_MILKYWAY_CHEVRON_SHUT(17, "gate_milkyway_chevron_shut", 1.5f, true),
	GATE_MILKYWAY_CHEVRON_OPEN(18, "gate_milkyway_chevron_open", 1.5f, true),
	GATE_ORLIN_DIAL(19, "gate_orlin_dial", 1.0f),
	
	
	// ----------------------------------------------------------
	// Stargate - Universe
	GATE_UNIVERSE_DIAL_START(70, "gate_universe_dial_start", 1.5f, true),
	GATE_UNIVERSE_CHEVRON_LOCK(71, "gate_universe_chevron_lock", 1.5f, true),
	GATE_UNIVERSE_CHEVRON_TOP_LOCK(72, "gate_universe_chevron_top_lock", 1.5f, true),
	GATE_UNIVERSE_DIAL_FAILED(73, "gate_universe_fail", 1.5f, true),
	GATE_UNIVERSE_OPEN(74, "gate_universe_open", 1.5f, true),
	GATE_UNIVERSE_CLOSE(75, "gate_universe_close", 1.5f, true),
	...
	SoundEventEnum(int id, String name, float volume, boolean attenuationMultiplied) {
		this(id, name, volume);
	...
	public float getVolumeMultiplied() {
		if (attenuationMultiplied)
			return volume * (float)AunisConfig.avConfig.audioRangeMultiplier;
