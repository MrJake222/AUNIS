 ...
 *
 */
public class StargateRequestStopToClient extends PositionedPacket {
	public StargateRequestStopToClient() {}
	
	public long worldTicks;
	public boolean moveOnly;
	
	public StargateRequestStopToClient(BlockPos pos, long worldTicks, boolean moveOnly) {
		super(pos);
	...
	public static class RequestStopClientHandler implements IMessageHandler<StargateRequestStopToClient, IMessage> {

		@Override
		public IMessage onMessage(StargateRequestStopToClient message, MessageContext ctx) {
