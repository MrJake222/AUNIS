 ...
 * @author MrJake222
 */
public class StargateSpinHelper {
	public StargateSpinHelper() {}
	...
	public EnumSymbol currentSymbol;
	...
	public StargateSpinHelper(EnumSymbol currentSymbol, EnumSpinDirection spinDirection, boolean isSpinning, EnumSymbol targetRingSymbol, long spinStartTime) {
	...
	public void initRotation(long totalWorldTime, EnumSymbol targetSymbol, EnumSpinDirection direction) {
...
//		Aunis.info("("+tick+", "+calculate((float) tick) * direction.mul+")");
	...
	public void fromBytes(ByteBuf buf) {
		...
		currentSymbol = EnumSymbol.valueOf(buf.readInt());
